...
const Tranjection_entity_1 = __importDefault(
  require("../entity/Tranjection.entity")
);
...
class LicenseController {
  constructor() {
    this.getAllLicense = express_async_handler_1.default((req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        const license = yield typeorm_1
          .createQueryBuilder("license", "license")
          .leftJoinAndSelect("cost", "cost", "license.costId = cost.id")
          .leftJoinAndSelect(
            "partner",
            "partner",
            "partner.id = license.partnerId"
          )
          .execute();
        return res.json({
          success: true,
    ...
    this.importLiscenseFromCsv = express_async_handler_1.default((req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        let license = [];
        fs_1.default
          .createReadStream(path_1.default.resolve(req.file.path))
    ...
    // activate license
    this.activateLicense = express_async_handler_1.default((req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        const checkLicense = yield typeorm_1
          .getConnection()
          .manager.find(License_entity_1.License, {
            where: {
              device: deviceId,
        ...
        const platform = yield typeorm_1
          .getConnection()
          .manager.findOne(Cost_entity_1.default, {
        ...
        const dLicense = yield typeorm_1
          .getConnection()
          .manager.findOne(License_entity_1.License, {
            where: {
              license,
              cost: platform.id,
            },
    ...
    this.checkdevice = express_async_handler_1.default((req, res) =>
      __awaiter(this, void 0, void 0, function* () {
    ...
    this.requestLicense = express_async_handler_1.default((req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        const partner = yield connectionManager.findOne(
          Partner_entity_1.default,
          {
            where: {
              shopId: shop_code,
            },
        ...
        const platform = yield connectionManager.findOne(
          Cost_entity_1.default,
          {
            where: {
    ...
    this.requestLicenseInsecure = express_async_handler_1.default((req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        const connectionManager = typeorm_1.getConnection().manager;
        const { phoneno, email, price, type, reference, shop_code } = req.body;
        const partner = yield connectionManager.findOne(
    ...
    this.sendLiscense = (reference, email, partner, platform, phoneno, cb) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        if (reference) {
          const testTranjection = yield typeorm_1
            .getConnection()
            .manager.findOne(Tranjection_entity_1.default, {
              where: { id: reference },
            });
          if (testTranjection) {
    ...
    this.khaltiPayment = express_async_handler_1.default((req, res) =>
      __awaiter(this, void 0, void 0, function* () {
    ...
    this.inappPurchase = express_async_handler_1.default((req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        const connectionManager = typeorm_1.getConnection().manager;
        ...
        const existPlatform = yield connectionManager.findOne(
          Cost_entity_1.default,
          {
            where: {
              platform: "phone",
        ...
        newLicense.timeOfActivation = moment_1
          .default(Date.now())
          .add({ year: 1 })
          .toDate();
        newLicense.license = `${license}`;
    ...
    this.requestLiscenseTest = express_async_handler_1.default((req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        const connectionManager = typeorm_1.getConnection().manager;
        const { phoneno, email, price, type, reference, shop_code } = req.body;
        const partner = yield connectionManager.findOne(
    ...
    this.createLicense = express_async_handler_1.default((req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        const errors = express_validator_1.validationResult(req);
        if (!errors.isEmpty()) {
          return res.status(400).json({ error: errors.array()[0]["msg"] });
